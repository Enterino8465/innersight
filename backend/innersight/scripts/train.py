...
def main() -> int:
    ...
    # ── Set env vars BEFORE any innersight import (config.py reads them) ─
    ...
    # ── MLP / Node2Vec path ───────────────────────────────────────────────────
    from innersight.training.trainer import train
    from innersight.config import BEST_MODEL_PT_FILE, STANDARDIZER_FILE
