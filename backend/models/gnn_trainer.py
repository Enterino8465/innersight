...
def train_gnn(
    ...
    try:
        from innersight.backend.scripts.extract_embeddings import extract_gnn_embeddings
...
if __name__ == '__main__':
    ...
    from innersight.backend.models.graph_builder import load_temporal_graphs as _load
